      ...
      /*  TextField sTField = new TextField();    //Time Should be in 0-24 Hour format
        ...
        addRecord.setOnAction(e->{          //Lambda Expression for triggering event and for adding record
            ...
            try{
              ...
              /*  Timestamp ts = new Timestamp(dp.getValue().getYear(), dp.getValue().getMonthValue(), dp.getValue().getDayOfMonth(), Integer.parseInt(sTField.getText().split(":")[0]), Integer.parseInt(sTField.getText().split(":")[1]),
                        0,
                        0
                );
                ...
                Database.addMovie(new Movie(name,tickets,price, null), fileInputStream);
                moviesUploads(null);
        ...
        vb.getChildren().addAll(nField, nTField, pTField, dp, fcButton, addRecord);
